...
**Nota**: l'ASTi dispone di punti radio SPORTident propri.
...
- Comunicazione basata su telefonia mobile
    ...
    - Controllare la copertura della rete 4G
...
- Ideale per 
    ...
    - per controllo dei concorrenti arrivati se l'arrivo è lontano dalla lettura chip (quindi anche senza risultati online). 
        - permette di anticipare il ritiro punti. 
        - facilita l'organizzazione del rifornimento 
    - controllo dei concorrenti passati a punti intermedi (anche senza risultati online).
        - permette di anticipare il ritiro punti di certe zone sapendo che tutti i concorrenti sono "usciti" dalla zona.
...
- Richiede un account sul sito SPORTident e i modem registrati sul proprio account. 
    - **I punti e modem ASTI sono registrati in un account ASTI**
    - **Per punti aggiuntivi non ASTI, richiedere per tempo a SPORTident l'assegnazione dei modem all'account ASTI**  
